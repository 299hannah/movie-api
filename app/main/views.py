...
def index():
    ...
    if search_movie:
        ...
        return render_template('index.html',message = message,title=title, popular=popular_movies,upcoming= upcoming_movie, now_playing=now_showing_movie)
...
def single_review(id):
    ...
    if review is None:
        abort(404)
    format_review = markdown2.markdown(review.movie_review,extras=['code-friendly', 'fenced-cod-blocks'])
